...
optimizers = ['adam', 'amsgrad', 'adamw', 'adagrad', 'adadelta']
...
for opt in optimizers:
    ...
    for lr in lrs:
        ...
        if opt == 'adam':
            ...
            optimizer = torch.optim.Adam(params, lr=lr, betas=(0.9, 0.999), eps=1e-08, weight_decay=0, amsgrad=True)
        elif opt == 'adamw':
            optimizer = torch.optim.AdamW(params, lr=lr, betas=(0.9, 0.999), eps=1e-08, weight_decay=0.01, amsgrad=False)
        elif opt == 'adagrad':
